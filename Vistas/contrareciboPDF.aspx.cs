                    ...
                    using (IDbConnection con = new SqlConnection(Extensions.GetBD_CFDI()))
                    {
                        string sql =
                            ...
                            SELECT
                                ...
                                FECHA_FACTURA,
                                TIPO_COMPROBANTE
                            FROM dbo.CFDI_XML_PSI WHERE CONTRA_RECIBO_ID = @ID";
                        ...
                        var contr = con.Query<CONTRA_RECIBOS>("SELECT * FROM CONTRA_RECIBOS_PSI WHERE ID = @ID", new { ID = pdf_id.Value }).FirstOrDefault();
