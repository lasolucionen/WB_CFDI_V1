...
namespace System.IO.Compression
{
    ...
    public class ZipStorer : IDisposable
    {
        ...
        public bool ExtractFile(ZipFileEntry _zfe, string _filename)
        {
            ...
            {
                //attr=File.GetAttributes(_filename);
            ...
            File.SetCreationTime(_filename, DateTime.Now); //_zfe.ModifyTime
            File.SetLastWriteTime(_filename, DateTime.Now); //_zfe.ModifyTime
            File.SetAttributes(_filename, FileAttributes.Normal);
            return result;
        }
        /// <summary>
        ...
        public bool ExtractFile(ZipFileEntry _zfe, Stream _stream)
        {
            ...
            do
            {
                count = inStream.Read(buffer, 0, size);
                if (count > 0)
                {
