...
var dataAdapter14 = new $.jqx.dataAdapter(source14);

$("#jGrid14").jqxGrid({
    width: '100%',
    height: 300,
    source: dataAdapter14,
    theme: 'Theme2',
    sortable: true,
    enableHover: false,
    ...
    //{ text: 'NUMLIN',     dataField: 'NUMLIN',        width: 70, renderer: columnrenderer2, cellsalign: 'center' },
                        ...
                        { text: 'REQ',            dataField: 'REQ',                      width: 90, renderer: columnrenderer2, cellsalign: 'center', cellclassname: cellclass4 },
                        { text: 'IVA',            dataField: 'IVA',                      width: 90, renderer: columnrenderer2, cellsalign: 'center', cellclassname: cellclass4 },
                        { text: 'Total',          dataField: 'TOTAL',                    width: 90,  renderer: columnrenderer2, cellsalign: 'center' },
