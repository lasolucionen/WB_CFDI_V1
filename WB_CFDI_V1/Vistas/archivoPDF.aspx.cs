...
namespace WB_CFDI_V1.Vistas
{
    public partial class archivoPDF : System.Web.UI.Page
    {
            ...
            if (pdf_id != null)
            {
                ...
                try
                {
                    ...
                    using (IDbConnection con = new SqlConnection(Extensions.GetBD_CFDI()))
                    {
                        string sql =
                            @"
                    SELECT XML,NOMBRE_ARCHIVO FROM dbo.CFDI_XML_PSI WITH (NOLOCK) WHERE ID = @ID";
        ...
        private void SetPDF(string emisorNombre, string emisorRFC, string emisorCalle, string emisorNoExterior,
            string emisorColonia, string emisorLocalidad, string emisorPais, string emisorEstado,
            string emisorCodigoPostal, string emisorRegimen, string folio, string complementoUUID, string noCertificado,
            string fecha, string receptorNombre, string receptorRFC, string receptorCalle, string receptorNoExterior,
            string receptorColonia, string receptorPais, string receptorEstado, string receptorCodigoPostal,
            string formaDePago, string metodoDePago, string numCtaPago, string subTotal, string ivaTasa,
            string ivaImporte, string iepsTasa, string iepsImporte, string total, string lugarExpedicion,
            List<Concepto> conceptos, string complementoSelloCFD, string complementoSelloSAT, string complementoVersion,
            string complementoNoCertificadoSAT, string complementoFechaTimbrado, CFDI_XML pdf, string moneda,
            string receptorUsoCFDI, string serie, string complementoRfcProvCertif, string descuento)
        {
            ...
            new SetP(document)
            {
                ...
                {"#descuento",                   descuento.Dbl().ToString("c2")},
            };
