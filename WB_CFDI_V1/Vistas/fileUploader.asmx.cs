...
/*            MailBee.Global.LicenseKey = "MN110-1C20DF387EA9952F661A118648FA-468F";
        ...
        public void Upload2()
        {
            ...
            try
            {
                ...
                //List<TmpXML> tmpXML = new List<TmpXML>();
                int tmpID = 1;
                ...
                if (ext1 == ".xml")
                {
                    ...
                    var znam  = Path.GetFileNameWithoutExtension(f1);
                    var zext  = Path.GetExtension(f1).ToLower();
                    ...
                    raw[znam].XML = file1.InputStream.GetStr();
                    if (file2 != null)
                    {
                        raw[znam].PDF = file2.InputStream.ToByteArray();
                    }

                }

                CFDI_XML_TMP.DeleteData();
                                    ...
                                    rs1.Add(
                                        new Data2
                                        {
                                            ...
                                            MENSAJE = "ya existe una factura con estos datos: <br />" +
                                                      "<strong>RFC:</strong> " + obj[0].RFC_EMISOR +
                                                      " <strong>Total:</strong> " + obj[0].TOTAL + "<br />" +
                                                      "<strong>Serie:</strong> " + obj[0].SERIE +
                                                      " <strong>Folio:</strong> " + obj[0].FOLIO +
                                                      "<strong>Fecha Factura:</strong> " + obj[0].FECHA_FACTURA,
                                            ERROR = true
                                        });
...
//ok
                            ...
                            var  req = "OPCIONAL";
                            if (User2.PEDIR_SERIE_FOLIO)
                            {
                                if (c33.TipoDeComprobante.ToUpper() == "E")
                                {
                                    User2.PEDIR_SERIE_FOLIO = false;
                                    requerido               = false;
                                }
                                else
                                {
                            ...
                            rs1.Add(
                                new Data2
                                {
                                    ...
                                    SERIE        = c33.Serie,
                                    FOLIO        = c33.Folio,
                                    TOTAL        = c33.Total.Dbl().ToString("C2"),
                                    RFC_RECEPTOR = receptorRFC,
                                    RFC_EMISOR   = emisorRFC,
                                    MENSAJE      = xml.Mensaje,
                                    SERIE_FOLIO  = req,
                            ...
                            var tmpXML = new CFDI_XML_TMP();
                            tmpXML.AddData(new CFDI_XML_TMP{
                                    Id=tmpID,
                                    Archivo= data.Value.PDF,
                                    Nombre_Archivo= data.Key,
                                    Xml= data.Value.XML,
                                    UUID= uuid,
                            });
                            ...
                            tmpXML.Add(new TmpXML
                            {
                                ...
                                emisorRFC         = emisorRFC,
                                total             = c33.Total,
                                subTotal          = c33.SubTotal,
                                impTras           = ImpTras,
                                version           = c33.Version,
                                fecha             = c33.Fecha.ToDateTime(),
                                pdf               = data.Value.PDF,
                                serie             = c33.Serie,
                                folio             = c33.Folio,
                                nombreArchivo     = data.Key,
                                estatus           = 1,
                                tipoDeComprobante = c33.TipoDeComprobante,
                                receptorRFC       = receptorRFC,
                                user2             = User2,
                                metodoPago        = c33.MetodoPago,
                                formaPago         = c33.FormaPago,
                                impRet            = ImpRet,
                                lstRet            = LstRet
                            });
                            */
                ...
                //HttpContext.Current.Session.Add("tmpXML", JsonConvert.SerializeObject(tmpXML));

                //CFDI_TMP_XML.AddData(JsonConvert.SerializeObject(tmpXML));


                //var tmpXml=(List<TmpXML>)HttpContext.Current.Session["tmpXML"];
