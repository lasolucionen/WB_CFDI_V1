...
namespace XML3
{
    static class XML_GEN
    {
        ...
        public static Comprobante DeserializeStr(this Comprobante obj, string xml)
        {
            ...
            catch (Exception ex)
            {
                try
                {
                    XmlSerializer deserializer = new XmlSerializer(typeof(XML3_4.Comprobante));
                    TextReader reader = new StringReader(xml);
                    XML3_4.Comprobante ob = (XML3_4.Comprobante)deserializer.Deserialize(reader);
                    reader.Close();
                    ...
                    */
                    ...
                    var com = ob.Adapt<XML3.Comprobante>();
    ...
    public class Concepto
    {
        ...
        [XmlElement(ElementName = "InformacionAduanera", Namespace = "http://www.sat.gob.mx/cfd/3")]
    ...
    [XmlRoot(ElementName = "InformacionAduanera", Namespace = "http://www.sat.gob.mx/cfd/3")]
